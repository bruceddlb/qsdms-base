...
(function () {
    ...
    SearchImage.prototype = {
        ...
        initEvents: function(){
            ...
            /* 选中图片 */
            domUtils.on($G('seaTradeist'), 'click', function(e){
                var target = e.target || e.srcElement,
        ...
        getImageData: function(){
            ...
            $G('seaTradeistUl').innerHTML = lang.seaTradeoading;
            ajax.request(url, {
                'dataType': 'jsonp',
                'charset': 'GB18030',
                ...
                'onerror':function(){
                    $G('seaTradeistUl').innerHTML = lang.searchRetry;
                }
            });
        },
        /* 添加图片到列表界面上 */
        ...
        getInsertList: function () {
            var child,
                ...
                align = getAlign(),
                list = [],
                items = $G('seaTradeistUl').children;
