...
namespace Trade.Data
{
    ...
    public partial class tbl_Order : Trade_SQLDB.Record<tbl_Order>  
    {
		...
		[Column] public int? ProCount { get; set; }





		[Column] public decimal? OrderMoney { get; set; }
		...
		[Column] public string MemberNo { get; set; }
		...
		[Column] public decimal? ServiceTotal { get; set; }





		[Column] public decimal? PayPoint { get; set; }
	...
	[TableName("tbl_MyPointLog")]


	[PrimaryKey("MyPointLogId", autoIncrement=false)]

	[ExplicitColumns]
    public partial class tbl_MyPointLog : Trade_SQLDB.Record<tbl_MyPointLog>  
    {



		[Column] public string MyPointLogId { get; set; }





		[Column] public string Descn { get; set; }
		...
		[Column] public decimal? Pt { get; set; }
	...
	[TableName("tbl_SalePlan")]


	[PrimaryKey("SalePlanId", autoIncrement=false)]

	[ExplicitColumns]
    public partial class tbl_SalePlan : Trade_SQLDB.Record<tbl_SalePlan>  
    {



		[Column] public string SalePlanId { get; set; }





		[Column] public string PlanTitle { get; set; }





		[Column] public DateTime? SaleStartTime { get; set; }





		[Column] public DateTime? SaleEndTime { get; set; }
		...
		[Column] public int? PlanStatus { get; set; }
	...
	[PrimaryKey("ShipFeesId", autoIncrement=false)]
    ...
    public partial class tbl_ShipFee : Trade_SQLDB.Record<tbl_ShipFee>  
    {
		...
		[Column] public string ShipFeesId { get; set; }





		[Column] public string ShipTempId { get; set; }
	...
	[TableName("tbl_SalePlanDetai")]


	[PrimaryKey("SalePlanDetaiId", autoIncrement=false)]

	[ExplicitColumns]
    public partial class tbl_SalePlanDetai : Trade_SQLDB.Record<tbl_SalePlanDetai>  
    {



		[Column] public string SalePlanDetaiId { get; set; }
    ...
    public partial class tbl_Product : Trade_SQLDB.Record<tbl_Product>  
    {
		...
		[Column] public int? SaleCount { get; set; }
		...
		[Column] public string Specifi { get; set; }
		...
		[Column] public string ServiceRuleId { get; set; }
	...
	[TableName("tbl_OrderDetail")]


	[PrimaryKey("OrderdetailId", autoIncrement=false)]

	[ExplicitColumns]
    public partial class tbl_OrderDetail : Trade_SQLDB.Record<tbl_OrderDetail>  
    {
		...
		[Column] public string BuyCount { get; set; }
		...
		[Column] public decimal? YunFee { get; set; }
		...
		[Column] public bool? IsSq { get; set; }
		...
		[Column] public decimal? ServicePrice { get; set; }





		[Column] public decimal? FreeServiceCount { get; set; }
    ...
    public partial class tbl_DeliverOrderDetail : Trade_SQLDB.Record<tbl_DeliverOrderDetail>  
    {
		...
		[Column] public int? BuyCount { get; set; }
    ...
    public partial class tbl_DeliverOrder : Trade_SQLDB.Record<tbl_DeliverOrder>  
    {
		...
		[Column] public string SaleOrderNo { get; set; }
	...
	[TableName("tbl_ProductRule")]


	[PrimaryKey("RuleId", autoIncrement=false)]

	[ExplicitColumns]
    public partial class tbl_ProductRule : Trade_SQLDB.Record<tbl_ProductRule>  
    {
	...
	[ExplicitColumns]
    public partial class tbl_Notice : Trade_SQLDB.Record<tbl_Notice>  
    {
		...
		[Column] public string NoticeContent { get; set; }
	...
	[TableName("tbl_Arrival")]


	[PrimaryKey("ArrivalId", autoIncrement=false)]

	[ExplicitColumns]
    public partial class tbl_Arrival : Trade_SQLDB.Record<tbl_Arrival>  
    {



		[Column] public string ArrivalId { get; set; }
		...
		[Column] public int? ArrivalStatus { get; set; }
	...
	[TableName("tbl_ServiceRule")]


	[PrimaryKey("ServiceRuleId", autoIncrement=false)]

	[ExplicitColumns]
    public partial class tbl_ServiceRule : Trade_SQLDB.Record<tbl_ServiceRule>  
    {
	...
	[TableName("tbl_LogistComp")]


	[PrimaryKey("LogistCompId", autoIncrement=false)]

	[ExplicitColumns]
    public partial class tbl_LogistComp : Trade_SQLDB.Record<tbl_LogistComp>  
    {



		[Column] public string LogistCompId { get; set; }





		[Column] public string LogistCompCode { get; set; }





		[Column] public string LogistCompName { get; set; }
