	...
	public partial class Database : IDisposable
	{
        ...
        public DataTable GetDatatable(string sql, params object[] args)
        {
            ...
            try
            {
                ...
                using (var cmd = CreateCommand(_sharedConnection, sql, args))
                {
                    using (var dbDataAdapter = _factory.CreateDataAdapter())
                    {
        ...
        #region
        public bool SqlBulkToDB(string tableName, System.Data.DataTable dt)
        {
            var isWrite = false;
            ...
            {
                OpenSharedConnection();
                var sqlConn = _sharedConnection as System.Data.SqlClient.SqlConnection;
                if (sqlConn != null)
                {
                    var bulkCopy = new System.Data.SqlClient.SqlBulkCopy(sqlConn);
