...
namespace Sys.Business
{
    ...
    public class SettingsBLL : BaseBLL<ISettingsService<SettingsEntity, SettingsEntity, Pagination>>
    {
        ...
        public List<SettingsEntity> GetPageList(SettingsEntity para, ref Pagination pagination)
        {
            ...
            BaseProvider.ConnectionStr = @"Data Source=DLB\SQLEXPRESS;Initial Catalog=xmxt_db;Persist Security Info=True;User ID=sa;Password=123;Asynchronous Processing=true;";
